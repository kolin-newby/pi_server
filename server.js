...
app.get('/', function(req, res) {
	...
	var query = "SELECT l.loc_desc AS name, l.loc_hours AS hours, d.volume_db AS volume FROM locations l RIGHT JOIN data d ON d.loc_id = l.loc_id WHERE d.time BETWEEN (NOW() - interval '" + REFRESH_INTERVAL + "') AND NOW();"; // select all locations and their latest reading
	db.any(query)
